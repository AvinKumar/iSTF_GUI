 ...
 * @author sayedmo
 */
public class ClickRadioBasedonTextLinkinTableTag extends SeleniumTagSupport {

    static Logger logger = Logger.getLogger(ClickRadioBasedonTextLinkinTableTag.class);
                    ...
                    for (WebElement row : allRows) {
                        ...
                        for (WebElement cell : cells) {
                            ...
                            if (cell.getText().equalsIgnoreCase(value)) {
                                ...
                                WebElement radio = row.findElement(By.xpath(".//td/input[@type='radio']"));
                                radio.click();
                                break;
