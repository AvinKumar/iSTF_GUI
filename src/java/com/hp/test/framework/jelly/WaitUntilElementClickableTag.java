 ...
 * @author sayedmo
 */
public class WaitUntilElementClickableTag extends SeleniumTagSupport {

    static Logger logger = Logger.getLogger(WaitUntilElementClickableTag.class);
    ...
    public void doTag(XMLOutput arg0) throws MissingAttributeException, JellyTagException {
        logger.info("Started Execution of WaitUntilElementClickable function");
        ...
        switch (bylocator) {
            ...
            case "name": {
                try {
                    ...
                    WebDriverWait wait = new WebDriverWait(driver, 300);
                    WebElement element = wait.until(ExpectedConditions.elementToBeClickable(By.name(locator)));
                } catch (TimeoutException e) {
                    System.out.println("TimeOut Exception"+ "\n" + e.getMessage());
                }
                break;
