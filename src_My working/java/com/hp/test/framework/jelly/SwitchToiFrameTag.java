 ...
 * @author avin
 */
public class SwitchToiFrameTag extends SeleniumTagSupport {
    ...
    public void doTag(XMLOutput arg0) throws MissingAttributeException, JellyTagException {
        logger.info("Started Execution of SwitchToiFrameTag");
        ...
        try {
            ...
            logger.error("Exception while switching to iFrame"+ "\n" + e.getMessage());
        }
        ...
        logger.info("End of Execution of SwitchToiFrameTag");
    }
